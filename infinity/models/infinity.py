...
class Infinity(nn.Module):
    ...
    def get_logits(self, h: torch.Tensor, cond_BD: Optional[torch.Tensor]):
        ...
        with torch.autocast('cuda', enabled=False):
            # print(f"🚀🚀🚀🚀🚀🚀🚀 {h.dtype=}, {cond_BD.dtype=}")
            # print(f"🚀🚀🚀🚀🚀🚀🚀 {self.head_nm.ada_lin[-1].weight.data.dtype=}, {self.head.weight.data.dtype=}")
    ...
    def forward(self, label_B_or_BLT: Union[torch.LongTensor, Tuple[torch.FloatTensor, torch.IntTensor, int]], x_BLC_wo_prefix: torch.Tensor, scale_schedule: List[Tuple[int]],
        ...
        **kwargs,
        ...
        with torch.amp.autocast('cuda', enabled=False):
            ...
            kv_compact = self.text_norm(kv_compact).contiguous() #; print(f"🚀🚀🚀🚀🚀🚀🚀 {kv_compact.dtype=}")
            sos = cond_BD = self.text_proj_for_sos((kv_compact, cu_seqlens_k, max_seqlen_k)).contiguous()    # cond_BD should be float32
            # print(f"🚀🚀🚀🚀🚀🚀🚀 {cond_BD.dtype=}, {sos.dtype=}")
            kv_compact = self.text_proj_for_ca(kv_compact).contiguous() #; print(f"🚀🚀🚀🚀🚀🚀🚀 {kv_compact.dtype=}")
            ...
            # print(f"🚀🚀🚀🚀🚀🚀🚀 {cond_BD_or_gss.dtype=}")
            
            sos = sos.unsqueeze(1).expand(B, 1, -1) + self.pos_start.expand(B, 1, -1) #; print(f"🚀🚀🚀🚀🚀🚀🚀 {sos.dtype=}")
            x_BLC = torch.cat((sos, self.word_embed(self.norm0_ve(x_BLC_wo_prefix))), dim=1) #; print(f"🚀🚀🚀🚀🚀🚀🚀 {x_BLC.dtype=}")
